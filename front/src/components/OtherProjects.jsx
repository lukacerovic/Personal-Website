  ...
  return (
    <div className='flex flex-col mb-[10vw]'>
        ...
        <div className='flex flex-wrap items-center justify-center gap-[5vw] xl:gap-[1.5vw]'>
            <div style={{backgroundColor:'black', gap:'2vw'}} className='w-[80%] md:w-[40%] xl:w-[23%] xl:h-[42vw] self-center rounded-lg flex flex-col text-white'>
                <video controls>
                    <source src="videos/pythonCarGame.MP4" type="video/mp4"/>
                </video> 
                <p className='text-center text-xs sm:text-md xl:text-[1vw]' style={{ padding:'0.5vw', paddingTop:'0.5vw', borderTopWidth:'1px'}}>
